            ...
            <header className='border-b border-border bg-surface/70 backdrop-blur'>
                <div className='mx-auto flex max-w-6xl items-center justify-between px-6 py-4'>
                    ...
                    <nav className='hidden items-center gap-6 text-sm text-text lg:flex'>
                        ...
                        <a className='hover:text-accent cursor-pointer' href='/teams' onClick={(e) => navigate('/teams', e)}>
                            {t('nav.teams')}
                        </a>
                ...
                <div className='flex h-full flex-col'>
                    ...
                    <div className='flex flex-1 flex-col overflow-y-auto p-6'>
                        ...
                        <nav className='flex flex-col gap-2'>
                            ...
                            <a href='/teams' className='rounded-lg px-4 py-3 text-sm text-text transition hover:bg-accent/10 hover:text-accent cursor-pointer' onClick={(e) => navigateAndClose('/teams', e)}>
                                {t('nav.teams')}
                            </a>
