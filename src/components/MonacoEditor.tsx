...
const MonacoEditor = ({
    ...
    useEffect(() => {
        ...
        monaco.editor.defineTheme('smctf-light', {
            base: 'vs',
            inherit: true,
            rules: [],
            colors: {
        ...
        monaco.editor.defineTheme('smctf-dark', {
            base: 'vs-dark',
            inherit: true,
            rules: [],
            colors: {
        ...
        monaco.editor.setTheme(theme === 'dark' ? 'smctf-dark' : 'smctf-light')
    }, [monaco, theme])
    ...
    return (
        <Editor
            ...
            theme={theme === 'dark' ? 'smctf-dark' : 'smctf-light'}
            options={{
                readOnly: readonly,
